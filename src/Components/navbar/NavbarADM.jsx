...
import { FaHome, FaChalkboardTeacher, FaSchool, FaBook, FaUserCircle, FaCalendarAlt, FaCalendar, FaSignOutAlt } from "react-icons/fa";
...
export default function Navbar() {
  ...
  const styles = {
    ...
    footer: {
      borderTop: "1px solid rgba(59, 100, 48, 0.1)", 
      paddingBottom: "10px"
    },
  ...
  return (
    <div style={styles.navbar}>
      ...
      <div style={styles.footer}>
        <button
          style={styles.button("logout-adm", null)}
          onClick={handleLogoutClick}
          onMouseEnter={() => setHovered("logout-adm")}
          onMouseLeave={() => setHovered(null)}
        >
          <FaSignOutAlt />
          <span>Sair</span>
